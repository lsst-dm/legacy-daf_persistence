...
class TestWriting(unittest.TestCase):
    ...
    def testCreateAggregateAndLoadingAChild(self):
        ...
        repoCfg = dp.Repository.cfg(id='repoC',
            ...
            parentCfgs=[dp.Access(dp.Access.cfg(storageCfg=dp.PosixStorage.cfg('tests/repository/repoA'))).getCfg()],
        ...
        repoCfg = dp.Repository.cfg(id='repoD',
            ...
            parentCfgs=[dp.Access(dp.Access.cfg(storageCfg=dp.PosixStorage.cfg('tests/repository/repoB'))).getCfg()],
