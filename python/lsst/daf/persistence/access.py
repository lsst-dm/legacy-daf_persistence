...
class Storage(object):
    ...
    def getMapperClass(root):
        raise butlerExceptions.NotImplemented("getMapperClass is not implemented by derived class")
...
class PosixStorage:
    ...
    def setCfg(self, repoCfg):
        ...
        #     cPickle.dump(repoCfg, outfile, cPickle.HIGHEST_PROTOCOL)
    ...
    def write(self, butlerLocation, obj):
        # self.log.log(pexLog.Log.DEBUG, "Put type=%s keys=%s to %s" % (datasetType, dataId, str(location)))
